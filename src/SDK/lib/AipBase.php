...
use Martialbe\LaravelBaiduAip\SDK\lib\AipHttpClient;
use Martialbe\LaravelBaiduAip\SDK\lib\AipSampleSigner;
/*
...
class AipBase {
     ...
     * @var string
     */
    protected $cachePrefix = 'baidu_aip_';
    ...
    private function getCacheKey(){
        return $this->cachePrefix.md5($this->apiKey);
    }
    ...
    private function writeAuthObj($obj){
        ...
        cache()->set($this->getCacheKey(), $obj, $obj['expires_in'] ?? 7200);
    }
    ...
    private function readAuthObj(){
        ...
        $obj = cache()->get($this->getCacheKey());
        if($obj){
